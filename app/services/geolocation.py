...
async def get_geolocation(request: GeoRequest) -> GeoLocationSerializer:
    """
    ...
    """
    ip_address = resolve_url_to_ip(request.ip_or_url) or request.ip_or_url
    ...
    return format_geolocation_response(ip_address, data)